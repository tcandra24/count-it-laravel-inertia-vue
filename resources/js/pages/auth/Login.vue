<template>
    <Head>
        <title>Login Account - Count IT</title>
    </Head>
    <AuthLayout>
                                    ...
                                    <div class="space-y-5">
                                        ...
                                        <div>
                                            ...
                                            <input
                                                ...
                                                :class="{
                                                    'focus:border-error-300 border-error-300 dark:border-error-700 dark:focus:border-error-800':
                                                        errors.email,
                                                }"
                                                class="dark:bg-dark-900 shadow-theme-xs focus:border-brand-300 focus:ring-brand-500/10 dark:focus:border-brand-800 h-11 w-full rounded-lg border border-gray-300 bg-transparent px-4 py-2.5 text-sm text-gray-800 placeholder:text-gray-400 focus:ring-3 focus:outline-hidden dark:border-gray-700 dark:bg-gray-900 dark:text-white/90 dark:placeholder:text-white/30"
                                            />
                                            <p v-if="errors.email" class="text-theme-xs text-error-500 mt-1.5">{{ errors.email }}</p>
                                        </div>
                                        <!-- Password -->
                                        <div>
                                            ...
                                            <div class="relative">
                                                ...
                                                />
                                                <p v-if="errors.password" class="text-theme-xs text-error-500 mt-1.5">{{ errors.password }}</p>
                                                <span
                                        ...
                                        <div class="flex items-center justify-between">
                                            ...
                                            <Link href="/reset-password" class="text-brand-500 hover:text-brand-600 dark:text-brand-400 text-sm"
